...
/** \brief Esta funcion pide por consola una cadena de caracteres.
*   \param list Passenger*
*   \param length int
*   \return int*
*/
void pedirUnaCadena(char cadena[], char mensaje[], int buffer)

/** \brief Esta funcion pide por consola una cadena de caracteres sin contenido NO alfabetico.
*   \param list Passenger*
*   \param length int
*   \return int*
*/
